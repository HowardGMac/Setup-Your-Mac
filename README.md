...
# Setup Your Mac (1.14.3) with SYM-Helper (1.1.1) via swiftDialog (2.4.2)
...
> Optimized to leverage SYM-Helper (1.1.1), Setup Your Mac (1.14.3) leverages new features of swiftDialog (2.4.2)
